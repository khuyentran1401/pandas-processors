...
import pandas as pd
from _utils import check_category_columns, check_numerical_columns
...
class MeanMedianImputer(DataFrameImputer):
    ...
    --------
    >>> import pandas as pd
    >>> from src.process_data import MeanMedianImputer
...
class ConstantImputer(DataFrameImputer):
    ...
    --------
    >>> import pandas as pd
    >>> from src.process_data import ConstantImputer
    >>> df = pd.DataFrame({'A': [1, 2, None], 'B': [4, None, 6]})
...
class CategoryImputer(DataFrameImputer):
    ...
    --------
    >>> import pandas as pd
    >>> from src.process_data import CategoryImputer
...
def impute_data(df: pd.DataFrame, imputers: list[DataFrameImputer]) -> pd.DataFrame:
    ...
    --------
    >>> import pandas as pd
    >>> from src.process_data import MeanMedianImputer, ConstantImputer, CategoryImputer
    >>> df = pd.DataFrame({
    ...     'A': [1, 2, None, 4],
    ...     'B': [5, None, 7, 8],
    ...     'C': ['a', None, 'c', 'd'],
